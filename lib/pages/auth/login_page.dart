    ...
    if (formKey.currentState!.validate()) {
      ...
      await authService
        ...
        if (value == true) {
          ...
          var role = await getUserRoles(FirebaseAuth.instance.currentUser!.uid);
          setState(() {
            HelperFunctions.userRole = role;
          });
...
Future<String?> getUserRoles(String uid) async {
  try {
